...
#     new_qr_code_data = {'qr_id': '456', 'other_data': 'value'}
#
#     # Make a POST request to create a new QR code
#     response = client.post('/qr_code/new', json=new_qr_code_data)
#
#     # Check if the response status code is 200 OK
#     assert response.status_code == 200
#
...
#     response = client.put(f'/qr_code/{qr_id}/edit', json=edited_qr_code_data)
#
#     # Check if the response status code is 200 OK
#     assert response.status_code == 200
#
...
#     response = client.delete(f'/qr_code/{qr_id}/delete')
#
#     # Check if the response status code is 200 OK
#     assert response.status_code == 200
#
