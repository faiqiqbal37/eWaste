            ...
            <div className="max-w-md mx-auto p-8 border rounded-md">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input placeholder= "Samsung Galaxy S22" type="text" id="brand" value={brand} onChange={(e) => setBrand(e.target.value)}
                    ...
                    <div className="mb-4">
                        ...
                        <select defaultValue="Mobile" id="deviceType" value={deviceType} onChange={(e) => setDeviceType(e.target.value)}
                    ...
                    <div className="mb-4">
                        ...
                        <select defaultValue="current" id="category" value={category} onChange={(e) => setCategory(e.target.value)}
                                className="form-select w-full border border-gray-300 rounded-md">
                    ...
                    <div className="mb-4">
                        ...
                        <input placeholder= "4000" type="number" id="price" value={price} onChange={(e) => setPrice(e.target.value)}
                               className="form-input w-full border border-gray-300 rounded-md"/>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <select defaultValue="No" id="selectService" value={selectService} onChange={(e) => setSelectService(e.target.value)}
                                className="form-select w-full border border-gray-300 rounded-md">
